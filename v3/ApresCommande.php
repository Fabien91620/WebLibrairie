...
<head>
    ...
    <title>WebLibrairie | Commande</title>
...
<div class="wrapper" id="wrapper">
    ...
    <div class="cart-main-area section-padding--lg bg--white">
        <div class="container">
            <?php $derPanier = getDernierPanier(); ?>
            <?php $numDerPanier = $derPanier->fetch(); ?>
            <h4 style="margin-left: 35%;">Vôtre commande est pris en compte !</h4>
            <h5 style="margin-left: 43%;">N° de commande : <?= $numDerPanier[0] ?></h5>
            <br>
            <a href="detailCommande.php?Commande=<?= $numDerPanier[0] ?>"><button id="btnAjouter"  class="tocart" title="Voir vôtre commande !" style="margin-left: 41%; background: #e59285 none repeat scroll 0 0; border: 0 none; color: #fff; font-size: 14px; font-weight: 600; height: 40px; line-height: 40px; padding: 0 25px; text-transform: uppercase;">Voir vôtre commande !</button></a>
        </div>
    </div>
    <!-- cart-main-area end -->
    <!-- Footer Area -->
