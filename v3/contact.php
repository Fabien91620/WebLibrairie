...
<head>
	...
	<title>WebLibrairie | Contact</title>
                    ...
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                            ...
                            <nav class="bradcaump-content">
                              ...
                              <span class="breadcrumb_item active">contact</span>
                            </nav>
                        </div>
                    </div>
                </div>
        		...
        		<div class="row">
        			<div class="col-lg-8 col-12">
        				<div class="contact-form-wrap">
        					<h2 class="contact__title">Faire un retour</h2>
                            ...
                            <div class="single-contact-form message">
                                <textarea name="message" id="message" placeholder="Rédiger votre message.."></textarea>
                            </div>
                            ...
                            <script>
                                $('#envoyer').click(function () {
                                    ...
                                    $.ajax({
                                        ...
                                        type : 'POST',
                                        data : 'prenom=' + prenom + '&nom=' + nom + '&mail=' + mail + '&sujet=' + sujet + '&message=' + message,
                                        dataType : 'html',
                                        success : function(code_html, statut){
                                            document.location.replace("ApresContact.php");
                                        }
                                    });
                                });
                            </script>
        			...
        			<div class="col-lg-4 col-12 md-mt-40 sm-mt-40">
        				<div class="wn__address">
        					<h2 class="contact__title">Nos informations</h2>
        					<p>Nous sommes passionnés de livre et nous espérons vous transmettre cette passion à travers se site</p>
        					<div class="wn__addres__wreapper">
        						...
        						<div class="single__address">
        							...
        							<div class="content">
        								<span>adresse:</span>
        								<p>12 rue jean de la fontaine, Paris(75), France</p>
        							</div>
        						</div>
        						...
        						<div class="single__address">
        							...
        							<div class="content">
        								<span>Mail</span>
        								<p>ServiceClient@weblibrairie.com</p>
        							</div>
        						</div>
        					</div>
        				</div>
