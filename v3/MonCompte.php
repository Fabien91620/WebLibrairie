...
<head>
    ...
    <title>WebLibrairie | Mon Compte</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section__title text-center">
                        <h2 class="title__be--2">Mon <span class="color--theme">Compte</span></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
                ...
                <div class="product product__style--3">
                    <a href="mesParametre.php" style=" height: 250px;">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <h2 style="text-align: center; margin-top: 30%; height: 238px;" class="title__be--2">Paramètre<br><span class="color--theme">de<br></span>sécuriter<br></h2>
                        </div>
                    </div>
                    </a>
                </div>
                ...
                <!-- Start Single Product -->
                <div class="product product__style--3">
                    <a href="mesCommande.php" style=" height: 250px;">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <h2 style="text-align: center; margin-top: 30%; height: 238px;" class="title__be--2">Mes <span class="color--theme">commandes</span></h2>
                        </div>
                    </div>
                    </a>
                </div>
                ...
                <!-- Start Single Product -->
                <div class="product product__style--3">
                    <a href="wishlist.php" style=" height: 250px;">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <h2 style="text-align: center; margin-top: 30%; height: 238px;" class="title__be--2">Ma <span class="color--theme">Wishlist</span></h2>
                        </div>
                    </div>
                    </a>
                </div>
                ...
                <!-- Start Single Product -->
                <div class="product product__style--3">
                    <a href="cart.php" style=" height: 250px;">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <h2 style="text-align: center; margin-top: 30%; height: 238px;" class="title__be--2">Mon <span class="color--theme">Panier</span></h2>
                        </div>
                    </div>
                    </a>
                </div>
