...
<head>
    ...
    <title>WebLibrairie | Mes Commandes</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section__title text-center">
                        <h2 class="title__be--2">Mes <span class="color--theme">Commandes</span></h2>
                    </div>
                </div>
            </div>
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <a href="detailCommande.php?Commande=<?= $data['ID'] ?>" style=" height: 250px;"><h2 style="text-align: center; margin-top: 25%;" class="title__be--2">Commande<br><span class="color--theme">N°<?= $data['ID'] ?><br></span>du<br><span class="color--theme"><?= $data['date'] ?></span></h2></a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
