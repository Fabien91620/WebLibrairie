...
<head>
    ...
    <title>WebLibrairie | Administration</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section__title text-center">
                        <h2 class="title__be--2">Adminis<span class="color--theme">tration</span></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <a href="ajouterGenre.php" style=" height: 250px;"><h2 style="text-align: center; margin-top: 25%;" class="title__be--2">Ajouter<br><span class="color--theme">des<br></span>genres</h2></a>
                        </div>
                    </div>
                </div>
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <a href="ajouterAuteur.php" style=" height: 250px;"><h2 style="text-align: center; margin-top: 25%;" class="title__be--2">Ajouter<br><span class="color--theme">des<br></span>écrivain</h2></a>
                        </div>
                    </div>
                </div>
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <a href="ajouterLivre.php" style=" height: 250px;"><h2 style="text-align: center; margin-top: 25%;" class="title__be--2">Ajouter<br><span class="color--theme">des<br></span>livres</h2></a>
                        </div>
                    </div>
                </div>
                <!-- Start Single Product -->
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <a href="gestionCompte.php" style=" height: 250px;"><h2 style="text-align: center; margin-top: 25%;" class="title__be--2">Gestion<br><span class="color--theme">des<br></span>comptes</h2></a>
                        </div>
                    </div>
                </div>
                <!-- Start Single Product -->
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb" style="border: solid; border-color: #e59285; border-width: 6px">
                            <a href="gestionRetour.php" style=" height: 250px;"><h2 style="text-align: center; margin-top: 25%;" class="title__be--2">Retours<br><span class="color--theme">des<br></span>clients</h2></a>
                        </div>
                    </div>
                </div>
            </div>
