...
<head>
	...
	<title>WebLibrairie | Description </title>
...
<body>
	...
	<div class="wrapper" id="wrapper">
        ...
        <div class="ht__bradcaump__area bg-image--4" style="padding-top: 45px; padding-bottom: 45px;">
        </div>
        <!-- End Bradcaump area -->
        <!-- Start main Content -->
        <?php $compteur = 0; ?>
        			...
        			<div class="col-lg-9 col-12">
        					...
        					<div class="row">
        						<div class="col-lg-6 col-12">
        							<div class="wn__fotorama__wrapper">
	        							<div class="fotorama wn__fotorama__action" data-nav="thumbs">
                                            <a href="1.jpg"><img src="<?= $data['SOURCE']; ?>" alt=""></a>
                                            <a href="1.jpg"><img src="<?= $data['SOURCE']; ?>" alt=""></a>
                                            <a href="1.jpg"><img src="<?= $data['SOURCE']; ?>" alt=""></a>
                                            <a href="1.jpg"><img src="<?= $data['SOURCE']; ?>" alt=""></a>
	        							</div>
        						...
        						<div class="col-lg-6 col-12">
        							<div class="product__info__main">
        								...
        								<div class="price-box">
        									<span><?= $data['PRIX_UNITAIRE'];?>0 €</span>
        								</div>
        								...
        								<div class="box-tocart d-flex">
        									...
        									<div class="    addtocart__actions">
                                                <?php if(isset($_SESSION['Usercompte'])): ?>
        										    <button id="btnAjouter" onclick="ajouterPanier(<?php echo $data['ID']; ?>, <?php echo $_SESSION['IdPanier']; ?>)" class="tocart" title="Ajouter">Ajouter</button>
        									    <?php else: ?>
                                                    <a href="my-account.php"><button id="btnAjouter" class="tocart" title="Ajouter">Ajouter</button></a>
                                                <?php endif; ?>
                                            </div>
											<div class="product-addto-links clearfix">
                                                <?php if(isset($_SESSION['Usercompte'])): ?>
                                                    <a onclick="ajouterWish(<?php echo $data['ID']; ?>, <?php echo $_SESSION['IdWishList']; ?>);" id="icoWishlist" class="wishlist" ></a>
                                                <?php else: ?>
                                                    <a href="my-account.php" id="icoWishlist" class="wishlist" ></a>
                                                <?php endif; ?>
                                                <script>
                                                    function ajouterWish(idLivre, idWishlist){
                                                        $.ajax({
                                                    ...
                                                    function ajouterPanier(idLivre, idWishlist){
                                                        var nb = $('#qty').val();
                                                        $.ajax({
                                                    ...
                                                    $( "#icoWishlist").parent()
                                                        .click(function() {
                                                            $(this)
                                                                ...
                                                                .animate({
                                                                    right: $(this).children('#icoWishlist').outerWidth()+'px',
                                                                    top:"0",

                                                                });
                                                            setTimeout(function(){ $( "#icoWishlist").hide(); }, 350);
                                                        });
                                                    $( "#btnAjouter").parent()
                                                        .click(function() {
                                                            $(this)
                                                                ...
                                                                .animate({
                                                                    right: $(this).children('#btnAjouter').outerWidth()+'px',
                                                                    top:"0",

                                                                });
                                                            setTimeout(function(){ $( "#btnAjouter").hide(); }, 350);
                                                        });
                                                </script>
											</div>
        								</div>
										<div class="product_meta">
											<span class="posted_in">Catégories:
                                                <?php if($compteur < 8): ?>
                                                    <a href="shop-grid.php?categorie=<?php echo $data['LIBELLE']; ?>"><?= $data['LIBELLE']; ?></a>,
                                                <?php endif; ?>
											</span>
										</div>
										<div class="product-share">
											<ul>
												<li class="categories-title">Partager :</li>
												<li>
													<a href="#">
	                        ...
	                        <div class="tab__container">
	                        	...
	                        	<div class="pro__tab_label tab-pane fade show active" id="nav-details" role="tabpanel">
									<div class="description__attribute">
										<p><?= $data['RESUME'];?></p>
                                        <ul>
                                            <li>• Auteur: <?= $data['NOM']." ".$data['PRENOM'];?></li>
                                            <li>• Date de Parution: <?= $data['DT_PARUTION'];?> </li>
                                        </ul>
									</div>
	                        	</div>
						...
						<div class="wn__related__product pt--80 pb--50">
							<div class="section__title text-center">
								<h2 class="title__be--2">Livres similaires</h2>
							</div>
							<div class="row mt--60">
						...
						<div class="wn__related__product">
							<div class="section__title text-center">
								<h2 class="title__be--2">Best Seller</h2>
							</div>
							<div class="row mt--60">
								<div class="productcategory__slide--2 arrows_style owl-carousel owl-theme">
									<!-- Start Single Product -->
        			...
        			<div class="col-lg-3 col-12 md-mt-40 sm-mt-40">
        				<div class="shop__sidebar">
        					...
        					<aside class="wedget__categories poroduct--tag">
        						...
        						<ul>
                                    <?php $genreLivre = descriptifLivre(); ?>
                                    <?php foreach($genreLivre as $data): ?>
