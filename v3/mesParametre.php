...
<head>
    ...
    <title>WebLibrairie | Paramètres</title>
    ...
    <section class="my_account_area pt--80 pb--55 bg--white">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section__title text-center">
                        <h2 class="title__be--2">Mes <span class="color--theme">Paramètres</span></h2>
                    </div>
                </div>
            </div>
            ...
            <?php foreach ($compte as $data): ?>
                <div class="row">
                    <div class="col-lg-6 col-12" style="margin-left: 26%;">
                        <div class="my__account__wrapper">
                            <form method="post" action="">
                                <div class="account__form">
                                    <span style="color: #e59285; font-size: 75%;">* champs obligatoire</span><span id="test" style="font-size: 75%;"></span>
                                    <div class="input__box">
                                        <label>User<span>*</span></label>
                                        <input onclick="save(this.id, true);" type="text" id="user" name="user" value="<?= $data['USER'] ?>" disabled>
                                    </div>
                                    <div class="input__box">
                                        <label>Mail<span>*</span></label>
                                        <input onclick="save(this.id, true);" type="email" id="email" name="email" value="<?= $data['ADRMAILCPTE'] ?>">
                                    </div>
                                    <div class="input__box">
                                        <label>Mot de passe<span>*</span></label>
                                        <input onclick="save(this.id, true);" type="password" id="mdp" name="mdp" value="<?= $data['MDP'] ?>">
                                    </div>
                                    <div class="input__box">
                                        <label>Nom</label>
                                        <input onclick="save(this.id, true);" type="text" id="nom" name="nom" value="<?= $data['NOMCPTE'] ?>">
                                    </div>
                                    <div class="input__box">
                                        <label>Prénom</label>
                                        <input onclick="save(this.id, true);" type="text" id="prenom" name="prenom" value="<?= $data['PRENOMCPTE'] ?>">
                                    </div>
                                    <div class="input__box">
                                        <label>N°Fixe</label>
                                        <input onclick="save(this.id, true);" type="text" id="numF" name="numF" value="<?= $data['NOTELCPTE'] ?>">
                                    </div>
                                    <div class="input__box">
                                        <label>N°Portable</label>
                                        <input onclick="save(this.id, true);" type="text" id="numP" name="numP" value="<?= $data['NOPORTCPTE'] ?>">
                                    </div>
                                    <span style="color: #e59285; font-size: 75%; margin-left: 71%;">** Sauvegarde automatique</span>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            if (!id_sel.is(e.target)&& id_sel.has(e.target).length === 0){
                ...
                if(valeurDivSortie != valeurDiv || valeurDivSortie == null){
                    if(bool == true){
                        ...
                        var telP = $('#numP').val();
                        $.ajax({
                            url : 'Ajax/ajaxSauvegardeParametre.php',
                            type : 'POST',
                            data : 'email=' + mail + '&mdp=' + mdp + '&nom=' + nom + '&prenom=' + prenom + '&telF=' + telF + '&telP=' + telP,
                            dataType : 'html',
                            success : function(code_html, statut){
