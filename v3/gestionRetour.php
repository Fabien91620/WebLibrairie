        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section__title text-center">
                        <h2 class="title__be--2">Retour <span class="color--theme">Client</span></h2>
                    </div>
                </div>
            </div>
            <div id="tablePanier" class="table-content wnro__table table-responsive">
                <table id="tableLivre">
                    ...
                    <tr class="title-top">
                        <th></th>
                        <th class="product-thumbnail">Sujet</th>
                    ...
                    <?php foreach ($livres as $data):?>
                        ...
                        <tr id="idTr_<?= $nb_liens ?>">
                            ...
                            <td class="product-remove"><a onclick="del2('idLigne_<?php echo $nb_liens ?>', 'idTr_<?= $nb_liens ?>')" style="margin-right: 10px; cursor: pointer;">X</a></td>
                            <td><textarea id="sujet_<?php echo $nb_liens ?>" style="width: 200%; background: #e5e5e5 none repeat scroll 0 0; border: medium none; border-radius: 3px; color: #333; font-size: 15px; font-weight: normal; height: 40px; padding: 0 5px 0 10px;" disabled><?= $data['SUJET'] ?></textarea></td>
                            <td><textarea id="mail_<?php echo $nb_liens ?>" style="width: 200%; background: #e5e5e5 none repeat scroll 0 0; border: medium none; border-radius: 3px; color: #333; font-size: 15px; font-weight: normal; height: 40px; padding: 0 5px 0 10px;" disabled><?= $data['MESSAGE'] ?></textarea></td>
                            <td><a href="detailRetour.php?id=<?php echo $data['ID'] ?>"><input type="button" value="Voir"></a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
...
<script>
    //Permet la suppression d'une ligne
    function del2(idLivre, idligne) {
        var id_livre = $('#'+ idLivre).val();
        $.ajax({
            url : 'Ajax/ajaxRetourDelete.php',
            type : 'POST',
            data : 'id=' + id_livre,
            dataType : 'html',
            success : function(code_html, statut){
