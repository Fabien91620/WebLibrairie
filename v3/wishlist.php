...
<body>
	...
	<div class="wrapper" id="wrapper">
        ...
        <div class="ht__bradcaump__area bg-image--5" style="padding-top: 45px; padding-bottom: 45px;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <h2 class="bradcaump-title" style="margin-left: 45%; margin-top: 1%;">Wishlist</h2>
        <!-- End Bradcaump area -->
                        ...
                        <div class="wishlist-content">
                            <form action="#">
                                <div class="wishlist-table wnro__table table-responsive">
                                    <?php if(isset($_SESSION['Usercompte'])): ?>
                                    <?php $nb_liens=0; $article = afficherWhishlist(); $article1 = afficherWhishlist(); ?>
                                    <?php $nbWhis = $article->fetch(); ?>
                                    <?php if($nbWhis > 1): ?>
                                    <table>
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php foreach($article1 as $data): ?>
                                                <?php $nb_liens++; ?>
                                                <tr id="idTr1_<?php echo $nb_liens ?>">
                                                    <td hidden><input id="idLivre1_<?php echo $nb_liens ?>" name="idLivre1_<?php echo $nb_liens ?>" type="hidden" value="<?php echo $data['ID'] ?>"></td>
                                                    <td class="product-remove"><a onclick="delW('idLivre1_<?php echo $nb_liens ?>', 'idTr1_<?php echo $nb_liens ?>');" href="#"><i class="zmdi zmdi-delete" style="font-size: 19px; margin-top: -20%;"></i></a></td>
                                                    <td class="product-thumbnail"><a href="single-product.php?livre=<?php echo $data['ID'] ?>"><img src="<?php echo $data['SOURCE'] ?>" alt=""></a></td>
                                                    <td class="product-name"><a href="single-product.php?livre=<?php echo $data['ID'] ?>"><?php echo $data['TITRE']; ?></a></td>
                                                    <td class="product-price"><span class="amount"><?php echo $data['PRIX_UNITAIRE']; ?>O€</span></td>
                                                    <td class="product-stock-status"><span class="wishlist-in-stock">En Stock</span></td>
                                                    <td class="product-add-to-cart"><a onclick="ajouterPanier(<?php echo $data['ID']; ?>, <?php echo $_SESSION['IdPanier']; ?>, 'idTr1_<?php echo $nb_liens ?>')" href="#"> Ajouter au panier</a></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                        <h5 style="margin-left: 38%;">Pas de livre dans vôtre wishlist </h5>
                                        <?php endif; ?>
                                            <?php else: ?>
                                            <a href="my-account.php"><h5 style="margin-left: 41%;">S'identifier / S'inscrire</h5></a>
                                            <?php endif; ?>
                                        <script>
                                            //Permet la suppression d'une ligne
                                            function delW(idLigne, idTr) {
                                                var id_ligne = $('#'+ idLigne).val();
                                                $.ajax({
                                                    url : 'Ajax/ajaxDeleteLivreWishlist.php',
                                                    type : 'POST',
                                                    data : 'id=' + id_ligne,
                                                    dataType : 'html',
                                                    success : function(code_html, statut){
                                            ...
                                            function ajouterPanier(idLivre, idWishlist, idTr){
                                                var nb = 1;
                                                $.ajax({
                                                    url : 'Ajax/ajaxAjouterLivrePanier.php',
                                                    type : 'POST',
                                                    data : 'idLivre=' + idLivre + '&idPanier=' + idWishlist + '&qty=' + nb,
                                                    dataType : 'html',
                                                    success : function(code_html, statut){
                                                        $.ajax({
                                                            url : 'Ajax/ajaxDeleteLivreWishlist.php',
