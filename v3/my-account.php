...
<head>
	...
	<title>WebLibrairie | S'identifier</title>
						...
						<div class="my__account__wrapper">
							...
							<form method="post" action="">
								<div class="account__form">
									...
									<div class="form__btn">
										<button name="inscrip" type="submit" >S'inscrire</button>
									</div>
									<?php if(isset($_POST['inscrip'])): ?>
                                        ...
                                        <?php if($success): ?>
                                            ...
                                            <?php if($conn): ?>
                                                <?php echo '<script>document.location.replace("index.php");</script>'; ?>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <?php echo  "<p class='forget_pass'> User déja connue</p>"; ?>
                                        <?php endif; ?>
									<?php endif; ?>
								</div>
							</form>
