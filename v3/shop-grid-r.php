...
<head>
	...
	<title>WebLibrairie | Recherche</title>
        					...
        					<aside class="wedget__categories poroduct--tag">
        						...
        						<ul>
                                    ...
                                    <?php foreach($genreLivre as $data): ?>
                                        <?php if($compteur < 20): ?>
                                            <?php $compteur++; ?>
                                            <li><a href="#"><?php echo $data['LIBELLE']; ?></a></li>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
        						</ul>
        					</aside>
        				...
        				<div class="tab__container">
	        				<div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
	        					<div class="row">
                                    ...
                                    <?php $livre = rechercheLivre270x340(); ?>
										...
										<div class="product__content content--center">
											...
											<div class="action">
												<div class="actions_inner">
													<ul class="add_to_links" style="margin-top: -10%;">
	        				...
	        				<div class="shop-grid tab-pane fade" id="nav-list" role="tabpanel">
	        					<div class="list__view__wrapper">
	        						<!-- Start Single Product -->
                                    <?php $compteur = 0; ?>
                                    <?php $livre = rechercheLivre450x565(); ?>
                                    <?php foreach($livre as $data): ?>
                                        <?php $compteur++; ?>
