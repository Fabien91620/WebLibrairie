...
<head>
    ...
    <title>WebLibrairie | Commande N°<?php echo $_GET['Commande'];?></title>
                                ...
                                <table>
                                    ...
                                    <?php foreach($livre as $data): ?>
                                        ...
                                        <tr id="idTr_<?php echo $compteur ?>">
                                            ...
                                            <td class="product-price"><span class="amount"><?= $data['NB_PRODUIT']; ?></span></td>
                                            <td class="product-subtotal"><?= $data['PRIXCALCULER']; ?>€</td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                                </table>
                                ...
                                <ul class="cart__total__tk">
                                    ...
                                    <?php foreach($prixTotal as $data): ?>
                                        <?php if($data['PRIX_TOTAL'] == null): ?>
                                            <li><?php echo 0;?> €</li>
                                        <?php else: ?>
                                            <li><?php echo $data['PRIX_TOTAL'];?> €</li>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                    <li>5.90€</li>
                                </ul>
                            ...
                            <div class="cart__total__amount">
                                ...
                                <?php foreach($prixTotal as $data): ?>
                                    <?php if($data['PRIX_TOTAL'] == null): ?>
                                        <span><?php echo 0;?> €</span>
                                    <?php else: ?>
                                        <span><?php echo $data['PRIX_TOTAL'] + 5.90;?>0€</span>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </div>
                        </div>
